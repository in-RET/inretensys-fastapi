...
""".format(
    ...
    with client.open_sftp() as sftp:
        ...
        sftp.put(
            os.path.join(os.getcwd(), "api", "required", "environment.yaml"),
            "environment.yaml",
        )
        sftp.put(
            os.path.join(
                os.getcwd(), "api", "required", "InRetEnsys-0.2a4-py3-none-any.whl"
            ),
            "InRetEnsys-0.2a4-py3-none-any.whl",
        )
